...
STRINGS = {
    ...
    "fin.giro_ricevuto": {"it": "Quanto ti hanno ridato (€)", "en": "How much you got back (€)", "es": "Cuánto te devolvieron (€)", "fr": "Combien on t'a rendu (€)", "de": "Wie viel du zurückbekamst (€)", "uk": "Скільки тобі повернули (€)"},
    "fin.giro_ricevuto_data": {"it": "Quando (rimborso)", "en": "When (refund)", "es": "Cuándo (reembolso)", "fr": "Quand (remboursement)", "de": "Wann (Erstattung)", "uk": "Коли (відшкодування)"},
    "fin.giro_ricevuto_wallet": {"it": "Dove è entrato", "en": "Where it came in", "es": "Dónde entró", "fr": "Où c'est entré", "de": "Wohin es kam", "uk": "Куди надійшло"},
    "fin.giro_diff_hint": {"it": "Conta solo la differenza: ridato di più = entrata (alla data del rimborso), di meno = uscita (alla data della spesa).", "en": "Only the difference counts: more back = income (on the refund date), less = expense (on the spend date).", "es": "Solo cuenta la diferencia: más devuelto = ingreso (fecha del reembolso), menos = gasto (fecha del gasto).", "fr": "Seule la différence compte : plus rendu = revenu (date du remboursement), moins = dépense (date de la dépense).", "de": "Nur die Differenz zählt: mehr zurück = Einnahme (am Erstattungsdatum), weniger = Ausgabe (am Ausgabedatum).", "uk": "Рахується лише різниця: повернули більше = дохід (дата відшкодування), менше = витрата (дата витрати)."},
    ...
    "fin.giro_close_btn": {"it": "Chiudi partita", "en": "Close entry", "es": "Cerrar partida", "fr": "Clôturer", "de": "Vorgang schließen", "uk": "Закрити запис"},
    ...
    "fin.giro_pending": {"it": "in attesa", "en": "pending", "es": "pendiente", "fr": "en attente", "de": "ausstehend", "uk": "очікується"},

...
STRINGS = {
    ...
    "fin.ai_note": {"it": "Inserimento manuale ora; in linguaggio naturale con l'AI (Fase 4).", "en": "Manual entry for now; natural language with the AI (Phase 4).", "es": "Entrada manual por ahora; en lenguaje natural con la IA (Fase 4).", "fr": "Saisie manuelle pour l'instant ; en langage naturel avec l'IA (Phase 4).", "de": "Vorerst manuelle Eingabe; in natürlicher Sprache mit der KI (Phase 4).", "uk": "Поки ручне введення; природною мовою з ШІ (Фаза 4)."},
